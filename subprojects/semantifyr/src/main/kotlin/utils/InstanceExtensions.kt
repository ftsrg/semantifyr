...
import hu.bme.mit.semantifyr.oxsts.semantifyr.transformation.resolution.PropertyResolver
...
private class InstanceExtensions(
    ...
    val propertyResolver = PropertyResolver(instance)
...
val Instance.propertyResolver
    get() = extensions.propertyResolver
