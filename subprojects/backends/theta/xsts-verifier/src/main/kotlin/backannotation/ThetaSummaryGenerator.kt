...
class ThetaSummaryGenerator {
    ...
    fun runThetaTracegen(progressContext: ProgressContext, xstsModel: XstsModel) {
    ...
    fun backAnnotateSummary(inlinedOxstsAssumptionWitness: InlinedOxstsAssumptionWitness) {
        val classWitness = oxstsClassAssumptionWitnessTransformer.transform(inlinedOxstsAssumptionWitness)
        val inlinedOxsts = assumptionWitnessBackAnnotator.createWitnessInlinedOxsts(classWitness)

        val resourceSet = inlinedOxstsAssumptionWitness.inlinedOxsts.eResource().resourceSet
        val path = inlinedOxstsAssumptionWitness.inlinedOxsts.eResource().uri.toString().replace("inlined.oxsts", "summary.oxsts")
    ...
    fun createSummary(progressContext: ProgressContext, classDeclaration: ClassDeclaration) {
        ...
        runThetaTracegen(progressContext, xstsModel)
...
//            backAnnotateSummary(inlinedOxstsWitness)
//        }
    }
