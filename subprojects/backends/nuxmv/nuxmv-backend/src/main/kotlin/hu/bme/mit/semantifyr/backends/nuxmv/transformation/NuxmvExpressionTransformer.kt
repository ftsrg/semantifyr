...
class NuxmvExpressionTransformer @Inject constructor(
    val nuxmvVariableTransformer: NuxmvVariableTransformer,
) : BackendExpressionVisitor<String>() {

    override val backendName: String = "nuXmv"

    private var substitution = emptyMap<VariableDeclaration, String>()
