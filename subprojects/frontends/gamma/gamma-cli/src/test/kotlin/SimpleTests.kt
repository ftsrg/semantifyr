...
class SimpleTests : VerificationCaseTest() {

    companion object {
        val gammaFile = "TestModels/Simple/Simple.gamma"
        val oxstsFile = "TestModels/Simple/Simple.oxsts"
        ...
        @JvmStatic
        fun `Verification cases should verify correctly with no par`(): Stream<VerificationCaseDefinition> {
    ...
    @Test
    fun `Should compile with no_par library`() {
    ...
    @ParameterizedTest
    @MethodSource
    fun `Verification cases should verify correctly with no par`(verificationCaseDefinition: VerificationCaseDefinition) {
