...
val generateXtextLanguage by tasks.registering(JavaExec::class) {
    ...
    inputs.file("src/main/java/hu/bme/mit/semantifyr/frontends/gamma/lang/GenerateGamma.mwe2")
    inputs.file("src/main/java/hu/bme/mit/semantifyr/frontends/gamma/lang/Gamma.xtext")

    outputs.dir("src/main/xtext-gen")
    outputs.dir("src/testFixtures/xtext-gen")
    outputs.dir(layout.buildDirectory.dir("generated/sources/xtext/ide"))

    args("src/main/java/hu/bme/mit/semantifyr/frontends/gamma/lang/GenerateGamma.mwe2", "-p", "rootPath=/$projectDir/..")
}
